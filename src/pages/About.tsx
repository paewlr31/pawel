  ...
  return (
    <section className="min-h-screen bg-gray-50 py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Lewa kolumna (Skills) – teraz na górze */}
        <div className="mb-20">
...
<hr className="border-gray-300 max-w-xl mx-auto" />
        {/* Prawa część – teraz jedna kolumna, ikonki nad tekstem */}
        <div className="space-y-20">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto md:mx-0">
              ...
              I write my own short stories from time to time, and I’m always planning the next solo backpacking adventure — so far Spain, Austria and the Greece have been my favorites. 
